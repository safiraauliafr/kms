...
class Forum extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->session->userdata('jabatan') == "CEO") {
            ...
            $this->load->view("user/ceo_forum", $home);
        } else {
            $home = array(
                "nip" => $this->session->userdata('nip', array(), true),
                "user_id" => $this->session->userdata('user_id', array(), true),
            ...
            $this->load->view("user/forum", $home);
        }
    }
    ...
    public function add_forum()
    {
        ...
        if ($this->session->userdata('jabatan') == "CEO") {
            ...
            $this->load->view("user/add_forum", $add_forum);
        } else {
            $add_forum = array(
    ...
    public function edit_forum($id)
    {
        ...
        $this->load->view("user/edit_forum", $data);
    }
    ...
    public function read_forum($id)
    {
        if ($this->session->userdata('jabatan') == "CEO") {
            ...
            $this->load->view("user/read_forum", $home);
        } else {
            $home = array(
                "sidebar" => $this->load->view("user/sidebar", array(), true),
                "nip" => $this->session->userdata('nip', array(), true),
    ...
    public function delete_komentar($id)
    {
        ...
        if ($this->forum_model->delete_komentar($id) && $this->create_log($email, $keterangan)) {
            redirect('user/forum/read_forum/' . $id);
        }
    }
    ...
    public function reply_forum($id)
    {
        ...
        if ($this->session->userdata('jabatan') == "CEO") {
            ...
            $this->load->view("user/reply_forum", $data);
        } else {
            $data = array(
                "sidebar" => $this->load->view("user/sidebar", array(), true),
                "nip" => $this->session->userdata('nip', array(), true),
    ...
    public function reply()
    {
        ...
        if ($this->form_validation->run() != false) {
            ...
            if (
                $this->forum_model->insert_komentar($data) && $this->create_nilai($email_, $ket, $nilai)
