                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-12 col-md-2">
                            <label>
                                <a href=" <?= base_url(); ?>index.php/admin/dokumen/add_dokumen/">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $row['tgl_dokumen']; ?></td>
                                <td><?php echo $status_doc; ?></td>

                                <td>
                                    <a
                                        href="<?= base_url(); ?>index.php/admin/dokumen/download/<?php echo $row['id_dokumen']; ?>">
                                    ...
                                    <br />
                                    <a
                                        href="<?= base_url(); ?>index.php/admin/dokumen/edit/<?php echo $row['id_dokumen']; ?>">
                                        <button type="button" class="btn btn-info btn-xs"><i class="fa fa-edit"></i>
                                            Edit</button>
                                        <br>
                                        <br />
                                        <a href="<?= base_url(); ?>index.php/admin/dokumen/delete/<?php echo $row['id_dokumen']; ?>"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="<?= base_url(); ?>index.php/admin/dokumen/upload_doc/<?php echo $row['id_dokumen']; ?>">
                                        <button type="button" class="btn btn-default btn-xs"><i
