                        ...
                        <div id="edit" class="tab-pane">
                            <div class="row">
                                <div class="col-lg-8 col-lg-offset-2 detailed">
                                    <h4 class="mb">Edit Dokumen</h4>
                                    <form role="form" class="form-horizontal"
                                        action="<?php echo base_url('index.php/admin/dokumen/updated/'); ?>"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <input type="text" maxlength="64" class="form-control"
                                                    id="status_dokumen" name="status_dokumen"
                                                    value="<?php echo $status; ?>" placeholder="Status Dokumen"
                                                    readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="kategori" class="col-sm-3 control-label">Kategori
                                                Dokumen</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="kategori" name="kategori"
                                                    value="<?php echo $row['kategori']; ?>"
                                                    placeholder="Kategori Dokumen" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-offset-2 col-lg-10">
                                                ...
                                                <a href="<?php echo base_url() . "index.php/admin/dokumen/index/" ?>"
