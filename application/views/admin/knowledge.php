        ...
        *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    ...
                    <label>
                        <a href=" <?= base_url(); ?>index.php/admin/knowledge/add_knowledge/">
                    ...
                    <div class="col-md-12">
                        <div class="custom-box">
                            ...
                            <a class="btn btn-warning btn-xs"
                                href="<?= base_url(); ?>index.php/admin/knowledge/edit_knowledge/<?php echo $row['id_knowledge']; ?>">Edit</a>
                            <a class="btn btn-theme02 btn-xs"
                                href="<?= base_url(); ?>index.php/admin/knowledge/read_knowledge/<?php echo $row['id_knowledge']; ?>">Read
                                More</a>
                            <a class="btn btn-danger btn-xs"
                                href="<?= base_url(); ?>index.php/admin/knowledge/delete/<?php echo $row['id_knowledge']; ?>"
                    ...
                    <div class="col-md-12">
                        <div class="custom-box">
                            ...
                            <a class="btn btn-warning btn-xs"
                                href="<?= base_url(); ?>index.php/admin/knowledge/edit_knowledge/<?php echo $row['id_knowledge']; ?>">
                                Edit</a>
                            <a class="btn btn-theme02 btn-xs"
                                href="<?= base_url(); ?>index.php/admin/knowledge/read_knowledge/<?php echo $row['id_knowledge']; ?>">Read
                                More</a>
