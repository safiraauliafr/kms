        ...
        <header class="header black-bg">
            ...
            <div class="top-menu">
                <ul class="nav pull-right top-menu">
                    <a href="<?= base_url('index.php/admin/dashboard', '') ?>" class="logo"></a>
                        ...
                        <div id="edit" class="tab-pane">
                            <div class="row">
                                <div class="col-lg-8 col-lg-offset-2 detailed">
                                    <h4 class="mb">Edit Knowledge</h4>
                                    <form role="form" class="form-horizontal"
                                        action="<?php echo base_url('index.php/admin/knowledge/update/'); ?>"
                                        class="form-horizontal" method="post" enctype="multipart/form-data">
                                        <?php foreach ($knowledge as $row) : ?>

                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">ID Knowledge</label>
                                            <div class="col-lg-6">
                                                <input type="text" placeholder="Masukkan ID Knowledge" id="id_knowledge"
                                                    name="id_knowledge" class="form-control"
                                                    value="<?php echo $row['id_knowledge']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Jenis KM</label>
                                            <div class="col-lg-6">
                                                <input type="text" placeholder="Masukkan Jenis" id="jenis" name="jenis"
                                                    class="form-control" value="<?php echo $row['jenis']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Nama Knowledge</label>
                                            <div class="col-lg-6">
                                                <input type="text" placeholder="Masukkan Nama Knowledge"
                                                    id="nama_knowledge" name="nama_knowledge" class="form-control"
                                                    value="<?php echo $row['nama_knowledge']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Deskripsi</label>
                                            <div class="col-lg-10">
                                                <textarea rows="10" cols="30" class="form-control" id="deskripsi"
                                                    name="deskripsi"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" placeholder="Gambar" id="gambar" name="gambar"
                                                    class="form-control" value="<?php echo $row['gambar']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-lg-offset-2 col-lg-10">
                                                <button class="btn btn-theme" type="submit">Save</button>
                                                <a href="<?php echo base_url() . "index.php/admin/knowledge/index/" ?>"
