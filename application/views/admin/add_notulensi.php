            ...
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-sm-9 col-sm-offset-1">
                        ...
                        ?>
                        <?= form_open('admin/notulensi/add', ['class' => 'form-horizontal']) ?>
                        ...
                        <div class="form-group">
                            <label for="waktu" class="col-sm-3 control-label">Waktu Notulensi</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="waktu" name="waktu"
                                    value="<?= set_value('waktu') ?>" placeholder="Waktu Notulensi" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="tempat" class="col-sm-3 control-label">Tempat Notulensi</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="tempat" name="tempat"
                                    value="<?= set_value('tempat') ?>" placeholder="Tempat Notulensi" required>
                            </div>
                        </div>
                        <div class="form-group">
