            ...
            <section class="wrapper site-min-height">
                ...
                <div class="chat-room mt">
                    <aside class="mid-side">
                        ...
                        <div class="room-desk">
                            <a href="<?= base_url(); ?>index.php/admin/forum/add_forum/"
                            ...
                            <div class="room-box">
                                ...
                                <a href="<?= base_url(); ?>index.php/admin/forum/edit_forum/<?= $row->id_forum ?>">
                                    <button type="button" class="btn btn-info btn-sm">
                                        <i class="fa fa-edit"></i> Edit</button>
                                </a>
                                <a href="<?= base_url(); ?>index.php/admin/forum/delete_forum/<?= $row->id_forum ?>"
                                    onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
                                    <button type="button" class="btn btn-danger btn-sm">
                                        <i class="fa fa-trash"></i> Hapus</button>
                                </a>

                                <a href="<?= base_url(); ?>index.php/admin/forum/read_forum/<?= $row->id_forum ?>">
