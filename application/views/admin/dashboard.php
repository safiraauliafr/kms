    ...
    <section id="container">
        ...
        *********************************************************************************************************************************************************** -->
            ...
            <header class="header black-bg">
                ...
                <!--logo start-->
                <!-- <p class="left"><img src="<?= base_url('assets/img/icon.png', '') ?>" class="img-circle" width="80">
                </p> -->
                ...
                <section class="wrapper">
                    <div class="col-md-13">
                        <div class="custom-box">
                            <div class="servicetitle">
                                <h4>Assalamu'alaikum, Selamat datang</h4>
                                <hr>
                            </div>
                            <div class="icn-main-container">
                            </div>
                            <h4>di halaman Administrator</h4>
                        </div>
                        <!-- end custombox -->
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 mb">
                        <div class="darkblue-panel pn">
                            ...
                            <h1 class="mt"><i class="fa fa-bullhorn fa-3x"></i></h1>
                            <footer>
                                <div class="centered">
                                    <a href="<?= base_url('index.php/admin/forum', '') ?>">
                                        <span><i class="fa fa-angle-right"></i> Read More</span></a> </div>
                            </footer>
                        </div> <!-- /darkblue panel -->
                    </div>
                    <div class="col-md-4 col-sm-4 mb">
                        <div class="darkblue-panel pn">
                            ...
                            <h1 class="mt"><i class="fa fa-paste fa-3x"></i></h1>
                            <footer>
                                <div class="centered">
                                    <a href="<?= base_url('index.php/admin/dokumen', '') ?>">
                                        <span><i class="fa fa-angle-right"></i> Read More</span></a> </div>
