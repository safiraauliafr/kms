                        ...
                        <div id="edit" class="tab-pane">
                            <div class="row">
                                <div class="col-lg-8 col-lg-offset-2 detailed">
                                    <h4 class="mb">Edit Notulensi</h4>
                                    <form role="form" class="form-horizontal"
                                        action="<?php echo base_url('index.php/admin/notulensi/update/'); ?>"
                                        class="form-horizontal" method="post" enctype="multipart/form-data">
                                        <?php foreach ($notulensi as $row) : ?>

                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">ID Notulensi</label>
                                            <div class="col-lg-6">
                                                <input type="text" placeholder="Masukkan ID Notulensi" id="id_notulensi"
                                                    name="id_notulensi" class="form-control"
                                                    value="<?php echo $row['id_notulensi']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" placeholder="Masukkan Nama Lengkap" id="user_nama"
                                                    name="user_nama" class="form-control"
                                                    value="<?php echo $row['nama_user']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Tanggal Post</label>
                                            <div class="col-lg-6">
                                                <input type="date" placeholder="Tgl Notulensi" id="tgl_notulensi"
                                                    name="tgl_notulensi" class="form-control"
                                                    value="<?php echo $row['tgl_notulensi']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Isi Notulensi</label>
                                            <div class="col-lg-10">
                                                <textarea rows="10" cols="30" class="form-control" id="isi_notulensi"
                                                    name="isi_notulensi"
                                                    required><?php echo $row['isi_notulensi']; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Waktu</label>
                                            <div class="col-lg-6">
                                                <input type="text" placeholder="Waktu" id="waktu" name="waktu"
                                                    class="form-control" value="<?php echo $row['waktu']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-2 control-label">Tempat</label>
                                            <div class="col-lg-6">
                                                <input type="text" placeholder="Tempat" id="tempat" name="tempat"
                                                    class="form-control" value="<?php echo $row['tempat']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-offset-2 col-lg-10">
                                                ...
                                                <a href="<?php echo base_url() . "index.php/admin/notulensi/index/" ?>"
