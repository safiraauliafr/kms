        ...
        *********************************************************************************************************************************************************** -->
        ...
        <section id="main-content">
            <section class="wrapper">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-center">Notulensi</h2>
                        <div class="col-sm-12 col-md-2">
                            <label>
                                <a href=" <?= base_url(); ?>index.php/admin/notulensi/add_notulensi/">
                                    <button type="button" class="btn btn-block btn-success">
                                        Add Notulensi</button>
                                </a>
                        </div>
                        </label>
                    </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            foreach ($notulensi as $row) :
                                ...
                                if ($row['status_notulensi'] == 1) {
                                    $status_not = "Tervalidasi";

                                    ?>

                            <tr>
                                <td><?= $no++ . "." ?></td>
                                <td><?php echo $row['id_notulensi']; ?></td>
                                <td><?php echo $row['isi_notulensi']; ?></td>
                                <td><?php echo $row['nama_user']; ?></td>
                                <td><?php echo $row['tgl_notulensi']; ?></td>
                                <td><?php echo $row['waktu']; ?></td>
                                <td><?php echo $row['tempat']; ?></td>
                                <td><?php echo $status_not; ?></td>

                                <td>
                                    <a
                                        href="<?= base_url(); ?>index.php/admin/notulensi/read_notulensi/<?php echo $row['id_notulensi']; ?>">
                                        <button type="button" class="btn btn-default btn-xs">Read</button>
                                    </a>
                                    <a href="<?= base_url(); ?>index.php/admin/notulensi/delete_notulensi/<?php echo $row['id_notulensi']; ?>"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a
                                        href="<?= base_url(); ?>index.php/admin/notulensi/edit_notulensi/<?php echo $row['id_notulensi']; ?>">
